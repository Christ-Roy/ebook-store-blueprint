            ...
            <div className="relative w-full max-w-md">
              ...
              <div className="relative">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white p-4 rounded-lg shadow-lg transform rotate-3 hover-scale">
                    <img src="/placeholder.svg" alt="Book cover" className="rounded" />
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-lg transform -rotate-2 hover-scale mt-8">
                    <img src="/placeholder.svg" alt="Book cover" className="rounded" />
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-lg transform -rotate-1 hover-scale">
                    <img src="/placeholder.svg" alt="Book cover" className="rounded" />
                  </div>
                  <div className="bg-white p-4 rounded-lg shadow-lg transform rotate-2 hover-scale mt-4">
                    <img src="/placeholder.svg" alt="Book cover" className="rounded" />
                  </div>
                </div>
              </div>
